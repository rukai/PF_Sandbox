...
pub fn upgrade_to_latest(meta: &mut Option<Value>, rules: &mut Option<Value>, fighters: &mut Vec<Option<Value>>, stages: &mut Vec<Option<Value>>) {
...
fn upgrade2(fighters: &mut Vec<Option<Value>>) {
    for fighter in fighters {
        if let &mut Some (ref mut fighter) = fighter {
...
fn upgrade1(fighters: &mut Vec<Option<Value>>) {
    for fighter in fighters {
        if let &mut Some (ref mut fighter) = fighter {
            if let Some (actions) = get_vec(fighter, "actions") {
                for action in actions {
...
fn upgrade0(fighters: &mut Vec<Option<Value>>) {
    for fighter in fighters {
        if let &mut Some (ref mut fighter) = fighter {
            if let Some (actions) = get_vec(fighter, "actions") {
                for action in actions {
